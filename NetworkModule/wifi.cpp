...
namespace NetworkModule
{
    ...
    const char *get_wifi_disconnection_string(uint8_t wifi_err_reason)
    {
    ...
    void wifi_event_handler(void *event_handler_arg, esp_event_base_t event_base, int32_t event_id, void *event_data)
    {
        ...
        {
            wifi_event_sta_disconnected_t *wifi_event_sta_disconnected = static_cast<wifi_event_sta_disconnected_t *>(event_data);
        ...
        case WIFI_EVENT_AP_STACONNECTED:
            network->isApConnected = true;
            ESP_LOGI(TAG, "WIFI_EVENT_AP_STACONNECTED");
            break;
        case WIFI_EVENT_AP_STADISCONNECTED:
            network->isApConnected = false;
    ...
    void wifi_initialise(int priority)
    {
        ...
        network->netif[0] = esp_netif_create_wifi(WIFI_IF_STA, &esp_netif_config);
